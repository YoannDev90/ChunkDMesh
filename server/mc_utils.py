...
async def get_fabric_versions(minecraft_version: Optional[str] = None) -> List[str]:
    ...
    """
    target_mc_version = minecraft_version or await get_latest_minecraft_release_version()
...
async def get_forge_versions(minecraft_version: Optional[str] = None, version_only: bool = False) -> List[str]:
    """
...
async def get_neoforge_versions(minecraft_version: Optional[str] = None, version_type: Optional[str] = None) -> List[str]:
    """
...
async def get_chunky_version(version: str, loader: str, minecraft_version: Optional[str] = None) -> str:
    """
    ...
    try:
        ...
        for release in data:
            ...
            if version != None:
                ...
                versions = {release.get("id"): release.get("downloads") for release in data}
